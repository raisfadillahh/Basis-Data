...
show tables;INSERT INTO customers (CustomerID, CustomerName, ContactName, Address, City, PostalCode, Country) VALUES
...
(50, 'Maison Dewey', 'Carlton DeWitt', '722 Wilson Blvd.', 'Arlington', '22204', 'USA'),
(51, 'Mère Hélène', 'Richard F. Smith', '5, rue de la paix', 'Toulouse', '31000', 'France'),
(52, 'Mille et une Nuits', 'Jean H. Perrin', '1, rue de la liberté', 'Pau', '64000', 'France'),
(53, 'Mundo de la comida', 'Hugo Olivares', 'Av. Concha y Toro 640', 'Santiago', '77500', 'Chile'),
...
SELECT Customers.CustomerName, Product.ProductName
FROM Customers
CROSS JOIN Product;
